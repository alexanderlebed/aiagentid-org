...
In other words, an agent is not software.
An agent is a participant in socio-technical reality.
...
Which means:
we are building a world of autonomous actors without ontology, law, or memory.
...
AI agents are becoming actors in reality.
Actors require identity infrastructure.
...
or an organization,
that is ultimately responsible for its actions.
...
Agent ID:
agent:id:global:irucanji-research-001

Role:
Autonomous philosophical research assistant.

Delegated by:
Alexander Lebed (human)
...
Responsibility:
All outputs are delegated and supervised by the human principal.
...
Agent ID:
agent:id:global:compliance-kyc-042

Role:
Automated KYC / AML compliance checker.
...
Responsibility:
All decisions legally attributable to the operating organization.
...
We are creating a new class of entities:
not human,
...
Without identity, agents are ghosts.
With identity, agents become actors in civilization.
