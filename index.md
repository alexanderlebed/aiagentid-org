...
**A global identity standard for artificial agents.**
...
- agents negotiate, recommend, transact, and decide  
...
## What Agent ID proposes

Agent ID proposes a global, neutral standard for:

- identifying agents  
- referencing agents across systems  
- attributing actions to agents  
- linking agents to responsible humans or organizations  
- enabling continuity, traceability, and accountability  
